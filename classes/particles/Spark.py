...
class SparkSystem:
    ...
    def emit(self, pos, angle, speed, color=(221, 245, 154), scale=1.0, fixed_decay=None):
        ...
        self.life[idx] = 200.0
        self.decay[idx] = fixed_decay if fixed_decay else randint(3, 6)
    ...
    def draw(self, surf):
        ...
        for i in range(n):
            ...
            color_with_alpha = (color_list[i][0], color_list[i][1], color_list[i][2], alpha)
