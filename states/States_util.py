...
def menu_maker(options, title, selected, surf):
    ...
    draw_text(surf, title, half_internal_res_width, half_internal_res_height - ten_percent_internal_res*1.0)
    ...
    for option in options:
        if selected == options.index(option):
            draw_text(surf, option, half_internal_res_width, (half_internal_res_height - y_gap) + five_percent_internal_res/2 * options.index(option), GAME_COLOR)
            if len(option) < 10:
                draw_text(surf, '|', half_internal_res_width + five_percent_internal_res, (half_internal_res_height - y_gap - 5) + five_percent_internal_res/2 * options.index(option), GAME_COLOR)
                draw_text(surf, '|', half_internal_res_width - five_percent_internal_res, (half_internal_res_height - y_gap - 5) + five_percent_internal_res/2 * options.index(option), GAME_COLOR)
            elif len(option) < 20:
                draw_text(surf, '|', half_internal_res_width + five_percent_internal_res*1.5, (half_internal_res_height - y_gap - 5) + five_percent_internal_res/2 * options.index(option), GAME_COLOR)
                draw_text(surf, '|', half_internal_res_width - five_percent_internal_res*1.5, (half_internal_res_height - y_gap - 5) + five_percent_internal_res/2 * options.index(option), GAME_COLOR)
            else:
                draw_text(surf, '|', half_internal_res_width + five_percent_internal_res*1.9, (half_internal_res_height - y_gap - 5) + five_percent_internal_res/2 * options.index(option), GAME_COLOR)
                draw_text(surf, '|', half_internal_res_width - five_percent_internal_res*1.9, (half_internal_res_height - y_gap - 5) + five_percent_internal_res/2 * options.index(option), GAME_COLOR)
        else:
            draw_text(surf, option, half_internal_res_width, (half_internal_res_height - y_gap) + five_percent_internal_res/2 * options.index(option))